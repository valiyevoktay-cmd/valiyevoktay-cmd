...
**Junior Data Engineer | Quantitative Economics | FinTech Enthusiast**
...
**High-Frequency Market Microstructure Engine**
* **The Tech:** Python (Asyncio), WebSockets, L2 Order Book Reconstruction.
* **The Quant:** Identifies informed order flow by calculating **Order Flow Imbalance (OFI)** and **OBI** at 100ms intervals. 
* *Built to detect "toxic" flow and absorption before they manifest in price action.*

#### 📊 [Baku Alternative CPI](https://github.com/valiyevoktay-cmd/baku-alternative-cpi)
**Automated Macroeconomic Tracker**
* **The Tech:** Python, Web Scraping, ETL Pipelines, Streamlit.
* **The Quant:** Calculates real-time inflation dynamics for Baku using the **Laspeyres Index** methodology, providing a high-frequency alternative to official state statistics.
---
...
### 📫 Let's Connect
<p align="left">
  <a href="mailto:veliyev.oktay19@gmail.com"><img src="https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white" alt="Email" /></a>
</p>

<div align="center">
  <sub>Baku 🇦🇿 → Jönköping 🇸🇪 | Always building.</sub>
</div>
